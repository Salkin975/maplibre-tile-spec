...
export function updateNullableSelectionVector(selectionVector: SelectionVector, nullabilityBuffer?: BitVector): SelectionVector {
    // If no nullability buffer and already a FlatSelectionVector, return the same instance
    if (!nullabilityBuffer && selectionVector instanceof FlatSelectionVector) {
