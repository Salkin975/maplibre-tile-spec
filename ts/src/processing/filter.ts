...
function executeVectorOperation(
    ...
    switch (operator) {
        ...
        case ">":
            if (hasSelection) {
                executeStrictComparisonSelected(vector, value, selectionVector, true);
                return selectionVector;
            }
        ...
        case "<":
            if (hasSelection) {
                executeStrictComparisonSelected(vector, value, selectionVector, false);
                return selectionVector;
            }
...
// ============================================================================
// OPTIMIZED STRICT COMPARISON (PHASE 2: Single-pass implementation)
// ============================================================================
...
function executeStrictComparison(
    ...
    // Single pass with direct comparison - OPTIMIZED
